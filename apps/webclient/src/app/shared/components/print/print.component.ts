...
import { IDENTITY_SERVICE, IdentityService, ToolbarService } from '@ballware/meta-services';
...
export class PrintComponent {
    ...
    constructor(private domSanitizer: DomSanitizer, private translationService: I18NextPipe, private metaApiService: MetaApiService, @Inject(IDENTITY_SERVICE) private identityService: IdentityService, private toolbarService: ToolbarService, private activatedRoute: ActivatedRoute) {
