...
export class EditLayoutStaticmultilookupComponent extends WithRequired(WithReadonly(WithValue(WithEditItemLifecycle(WithDestroy()), () => [] as any[]))) implements OnInit, EditItemRef {
