...
@Component({
    selector: 'ballware-detail-column-bool',
    templateUrl: './detailcolumnbool.component.html',
    styleUrls: ['./detailcolumnbool.component.scss'],
    imports: [CommonModule, DxCheckBoxModule, DxValidatorModule]
})
export class DetailColumnBoolComponent implements OnInit {
    ...
    ngOnInit(): void {
        ...
        if (this.detailItem && this.identifier) {
            this.value = get(this.detailItem, this.identifier) as boolean;
        }
