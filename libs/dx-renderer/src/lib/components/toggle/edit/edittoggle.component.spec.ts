...
import { EditLayoutToggleComponent } from './edittoggle.component';
...
describe('EditLayoutBoolComponent', () => {
  ...
  it('should create', () => {
    fixture = TestBed.createComponent(EditLayoutToggleComponent);
  ...
  it('should apply options', () => {
    ...
    expect(component.livecycle.getOption('value')).toBe(false);
    ...
    component.livecycle.setOption('value', true);
    expect(component.livecycle.getOption('value')).toBe(true);
