...
import {
    DxHtmlEditorComponent, DxHtmlEditorModule, DxValidatorModule
...
@Component({
    selector: 'ballware-detail-column-richtext',
    templateUrl: './detailcolumnrichtext.component.html',
    styleUrls: ['./detailcolumnrichtext.component.scss'],
    imports: [CommonModule, DxHtmlEditorModule, DxValidatorModule]
})
export class DetailColumnRichtextComponent implements OnInit {
