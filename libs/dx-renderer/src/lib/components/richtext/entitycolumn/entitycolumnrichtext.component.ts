...
import { ValueChangedEvent as RichtextValueChangedEvent } from "devextreme/ui/html_editor";
import { cloneDeep, get, set } from "lodash";
import { combineLatest } from "rxjs";
import { CommonModule } from "@angular/common";
import {
  DxHtmlEditorComponent, DxHtmlEditorModule
} from 'devextreme-angular';
import { takeUntilDestroyed } from '@angular/core/rxjs-interop';

@Component({
    selector: 'ballware-entity-column-richtext',
    templateUrl: './entitycolumnrichtext.component.html',
    styleUrls: [],
    imports: [CommonModule, DxHtmlEditorModule]
})
export class EntityColumnRichtextComponent implements OnInit {
    @ViewChild('textbox', { static: false }) textbox?: DxHtmlEditorComponent;
    ...
    onValueChanged: ((e: RichtextValueChangedEvent) => void)|undefined;
    ...
    ngOnInit(): void {
        ...
        combineLatest([
          ...
          if (editorValueChanged) {
              ...
              this.onValueChanged = (e: RichtextValueChangedEvent) => {
