...
@Component({
    ...
    templateUrl: './detailcolumntextarea.component.html',
    styleUrls: ['./detailcolumntextarea.component.scss'],
    imports: [CommonModule, DxTextAreaModule, DxValidatorModule]
})
export class DetailColumnTextareaComponent implements OnInit {
