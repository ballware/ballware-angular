...
import { SpeechInputComponent } from "../../speechinput";
import { takeUntilDestroyed } from '@angular/core/rxjs-interop';

@Component({
    selector: 'ballware-edit-textarea',
    templateUrl: './edittextarea.component.html',
    styleUrls: ['./edittextarea.component.scss'],
    imports: [CommonModule, I18NextPipe, DxTextAreaModule, DxButtonModule, DxPopupModule, DxValidatorModule, SpeechInputComponent],
