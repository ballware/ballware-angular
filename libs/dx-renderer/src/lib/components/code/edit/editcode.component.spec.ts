...
import { EditLayoutCodeComponent } from './editcode.component';
import { Provider } from '@angular/core';
import { EDIT_SERVICE, TRANSLATOR } from '@ballware/meta-services';
import { EditLayoutItem } from '@ballware/meta-model';
import { mockedEditServiceContext } from '../../../../test/editservice.spec';

describe('EditLayoutCodeComponent', () => {
  let component: EditLayoutCodeComponent;
  let fixture: ComponentFixture<EditLayoutCodeComponent>;
  ...
  beforeEach(async () => {
    await TestBed.configureTestingModule({
      imports: [ EditLayoutCodeComponent ],
      providers: [
        {
          provide: TRANSLATOR,
  ...
  it('should create', () => {
    fixture = TestBed.createComponent(EditLayoutCodeComponent);
