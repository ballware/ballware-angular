...
import {
  DxTextBoxComponent, DxTextBoxModule
} from 'devextreme-angular';
import { takeUntilDestroyed } from '@angular/core/rxjs-interop';

@Component({
    selector: 'ballware-entity-column-text',
    templateUrl: './entitycolumntext.component.html',
    styleUrls: [],
    imports: [CommonModule, DxTextBoxModule]
})
export class EntityColumnTextComponent implements OnInit {
