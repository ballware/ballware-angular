...
@Component({
    selector: 'ballware-detail-column-text',
    templateUrl: './detailcolumntext.component.html',
    styleUrls: ['./detailcolumntext.component.scss'],
    imports: [CommonModule, DxTextBoxModule, DxValidatorModule]
})
export class DetailColumnTextComponent implements OnInit {
