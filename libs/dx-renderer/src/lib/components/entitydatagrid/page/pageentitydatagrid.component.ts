...
@Component({
    ...
    templateUrl: './pageentitydatagrid.component.html',
    styleUrls: ['./pageentitydatagrid.component.scss'],
    providers: [
        {
...
export class PageLayoutEntityDataGridComponent implements OnInit {

  @Input() layoutItem?: PageLayoutItem;

  private readonly _storageIdentifier$ = new BehaviorSubject<string|undefined>(undefined);
  private readonly _layoutIdentifier$ = new BehaviorSubject<string|undefined>(undefined);
  private readonly _height$ = new BehaviorSubject<string|undefined>('100%');
