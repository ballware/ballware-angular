...
@Component({
    selector: 'ballware-edit-attachmentdatagrid',
    templateUrl: './editattachmentdatagrid.component.html',
    styleUrls: [],
    providers: [
      {
  ...
  export class EditLayoutAttachmentDataGridComponent implements OnInit {
