...
@Component({
    ...
    imports: [CommonModule, I18NextPipe, DxToolbarModule, DxSelectBoxModule, DxButtonModule, ZXingScannerModule]
})
export class BarcodeScannerComponent implements OnDestroy, OnChanges {
    ...
    constructor(
      @Inject(INTERACTION_SERVICE) private readonly interactionService: InteractionService,
