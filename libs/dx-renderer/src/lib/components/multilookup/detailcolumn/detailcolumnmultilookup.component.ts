...
@Component({
    selector: 'ballware-detail-column-multilookup',
    templateUrl: './detailcolumnmultilookup.component.html',
    styleUrls: ['./detailcolumnmultilookup.component.scss'],
    imports: [CommonModule, DxTagBoxModule, DxValidatorModule]
})
export class DetailColumnMultilookupComponent implements OnInit {
    ...
    ngOnInit(): void {
        ...
        if (this.detailItem && this.identifier) {
            this.value = get(this.detailItem, this.identifier) as unknown[] || [];
        }
