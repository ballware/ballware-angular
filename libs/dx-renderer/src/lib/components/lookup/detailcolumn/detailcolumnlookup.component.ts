...
import {
    DxSelectBoxComponent, DxSelectBoxModule, DxValidatorModule
...
@Component({
    selector: 'ballware-detail-column-lookup',
    templateUrl: './detailcolumnlookup.component.html',
    styleUrls: ['./detailcolumnlookup.component.scss'],
    imports: [CommonModule, DxSelectBoxModule, DxValidatorModule]
})
export class DetailColumnLookupComponent implements OnInit {
