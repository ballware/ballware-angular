...
import { EditUtil, ScriptUtil } from "@ballware/meta-model";
...
describe("compileEvaluateCustomFunction", () => {
    it("should compile default implementation for undefined custom script", () => {
        ...
        subject('function', false, mockedEditUtil, mockedLookups, mockedScriptUtil, mockedParam, saveCallback, messageCallback);
    ...
    it("should compile and and throw error from custom script", () => {
        ...
        expect(() => subject('function', false, mockedEditUtil, mockedLookups, mockedScriptUtil, mockedParam, saveCallback, messageCallback)).toThrowError('Expected error');
    })
})